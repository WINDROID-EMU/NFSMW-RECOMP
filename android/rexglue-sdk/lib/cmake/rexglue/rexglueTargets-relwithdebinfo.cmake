...
# Import target "rex::gpu-plume" for configuration "RelWithDebInfo"
set_property(TARGET rex::gpu-plume APPEND PROPERTY IMPORTED_CONFIGURATIONS RELWITHDEBINFO)
set_target_properties(rex::gpu-plume PROPERTIES
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELWITHDEBINFO "rex::runtime"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/librexgpu-plumerd.so"
  IMPORTED_SONAME_RELWITHDEBINFO "librexgpu-plumerd.so"
  )

list(APPEND _cmake_import_check_targets rex::gpu-plume )
list(APPEND _cmake_import_check_files_for_rex::gpu-plume "${_IMPORT_PREFIX}/lib/librexgpu-plumerd.so" )
